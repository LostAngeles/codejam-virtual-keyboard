...
if (localStorage.length) lang = JSON.parse(localStorage.getItem('lang')); // if LS is not empty set the lang
...
function change() { 
	lang *= -1;
	localStorage.setItem('lang', JSON.stringify(lang));             // Save the lang to LS
	if (lang == "1") {
